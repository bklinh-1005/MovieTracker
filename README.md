# Projec Movie Tracker 
#-------------HỆ THỐNG THEO DÕI VÀ ĐÁNH GIÁ PHIM-----------
# I. GIỚI THIỆU ĐỀ TÀI
# Lý do chọn đề tài:
# Hiện trạng : Xem phim và series là một trong những hình thức giải trí phổ biến nhất hiện nay, với mỗi người trung bình xem hàng chục đến hàng trăm bộ phim mỗi năm.
#
# Hạn chế thực tế:
...
# 3. Xem chi tiết phim: gồm poster, mô tả, diễn viên, đạo diễn, rating, trailer
# 4. Đánh dấu trạng thái: đã xem/ muốn xem(watchlist)/đang xem(đối với các series)
...
# Môi trường: IntelliJ IDEA
# Ngôn ngữ lập trình: JAVA
# Backend Framework: Spring Boot
# Frontent: HTML/CSS + Thymeleaf
